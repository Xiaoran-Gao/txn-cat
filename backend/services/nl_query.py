...
- raw_description 是原始账单描述，display_description 是清洗后用于展示和搜索的交易描述。用户问交易描述/商户/用途时优先使用 display_description。
